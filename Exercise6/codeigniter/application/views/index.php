  ...
  <style>
	...
	<body background="<?php echo base_url();?>/images/Background.jpg">
      <head>
        ...
        <td align="center"><a href="<?php echo base_url() . "index.php/users/delete/" . $u_key->user_id; ?>" onClick="show_confirm('delete',<?php echo $u_key->user_id;?>)"><img src="<?php echo base_url();?>/images/delete.png" style="width: 20px"></img></a></td>
